<template>
  <section>
    <div class="__space" style="margin-top: 0.8rem">
      <div
      ...
      >
        <client-only>
          ...
          >
            <!-- note! you have to remove this div on production  -->
            <div
              v-for="(column, i) in container"
              :key="i"
              class="__active relative"
              style="margin-top: 2rem; width: 100%; padding: 1px"
            >
              <!-- handlers for rows -->
              <div
                handler="section"
                class="absolute __section bg-border-400 py-1 px-4 tracking-wider"
              >
                <p class="text-sm font-body">Section</p>
              </div>
              <div handler="control" class="absolute __set bg-border-400">
              ...
              <table style="width: 100%">
                ...
                >
                  ...
                  <td
                    ...
                    `"
                    :style="{ width: 100 / column.list.length + '%' }"
                  >
                    <div
                      v-if="!element.name"
  ...
  methods: {
    logger(event, i) {
      ...
      if (event.added) {
        ...
        // this should be for incoming elements
        if (JSON.stringify(event.added.element) === JSON.stringify({})) {
          // do nothing
        } else if (
